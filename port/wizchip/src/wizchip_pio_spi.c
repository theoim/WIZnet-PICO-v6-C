...
int wizchip_pio_spi_init(const wizchip_pio_spi_config_t *config)
{
  ...
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io0_pin],
                (uint)(3 << PADS_BANK0_GPIO0_DRIVE_LSB), 
                PADS_BANK0_GPIO0_DRIVE_BITS);
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io0_pin],
                (uint)(1 << PADS_BANK0_GPIO0_SLEWFAST_LSB),
                PADS_BANK0_GPIO0_SLEWFAST_BITS);

  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io1_pin],
                (uint)(3 << PADS_BANK0_GPIO0_DRIVE_LSB), 
                PADS_BANK0_GPIO0_DRIVE_BITS);
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io1_pin],
                (uint)(1 << PADS_BANK0_GPIO0_SLEWFAST_LSB),
  ...
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io2_pin],
                (uint)(3 << PADS_BANK0_GPIO0_DRIVE_LSB),  
                PADS_BANK0_GPIO0_DRIVE_BITS);
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io2_pin],
                (uint)(1 << PADS_BANK0_GPIO0_SLEWFAST_LSB),
  ...
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io3_pin],
                (uint)(3 << PADS_BANK0_GPIO0_DRIVE_LSB), 
                PADS_BANK0_GPIO0_DRIVE_BITS);
  hw_write_masked(&pads_bank0_hw->io[active_state->pio_spi_config->data_io3_pin],
                (uint)(1 << PADS_BANK0_GPIO0_SLEWFAST_LSB),
